...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class VerificationBusinessWebsiteAttributes : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes_checks>? Checks { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes_checks> Checks { get; set; }
#endif
...
#nullable restore
        ...
        public List<string> Tags { get; set; }
#endif
        /// <summary>The website URL being verified.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes"/> and sets the default values.
        /// </summary>
        public VerificationBusinessWebsiteAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "checks", n => { Checks = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes_checks>(global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes_checks.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "website-url", n => { WebsiteUrl = n.GetStringValue(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationBusinessWebsiteAttributes_checks>("checks", Checks);
            ...
            writer.WriteStringValue("website-url", WebsiteUrl);

...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class VerificationQesInfocertAttributes : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes_checks>? Checks { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes_checks> Checks { get; set; }
#endif
...
#nullable restore
        ...
        public List<string> Tags { get; set; }
#endif
        /// <summary>An InfoCert-specific sub-state describing why the verification is in a tentative status. Only populated when the verification status is `tentatively_passed` or `tentatively_failed`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? TentativeSubState { get; set; }
#nullable restore
#else
        public string TentativeSubState { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes"/> and sets the default values.
        /// </summary>
        public VerificationQesInfocertAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "checks", n => { Checks = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes_checks>(global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes_checks.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "tentative-sub-state", n => { TentativeSubState = n.GetStringValue(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationQesInfocertAttributes_checks>("checks", Checks);
            ...
            writer.WriteStringValue("tentative-sub-state", TentativeSubState);

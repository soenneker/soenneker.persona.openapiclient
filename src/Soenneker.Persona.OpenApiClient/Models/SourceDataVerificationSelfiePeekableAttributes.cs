...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class SourceDataVerificationSelfiePeekableAttributes : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationSelfiePeekableAttributes"/> and sets the default values.
        /// </summary>
        public SourceDataVerificationSelfiePeekableAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationSelfiePeekableAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationSelfiePeekableAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationSelfiePeekableAttributes();
        }
        /// <summary>

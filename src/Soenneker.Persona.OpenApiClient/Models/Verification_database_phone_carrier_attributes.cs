...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class Verification_database_phone_carrier_attributes : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string AddressSubdivision { get; set; }
#endif
        /// <summary>Birthdate in the format &quot;YYYY-MM-DD&quot;.</summary>
        public Date? Birthdate { get; set; }
        /// <summary>The checks property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes_checks>? Checks { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes_checks> Checks { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes"/> and sets the default values.
        /// </summary>
        public Verification_database_phone_carrier_attributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "checks", n => { Checks = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes_checks>(global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes_checks.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.Verification_database_phone_carrier_attributes_checks>("checks", Checks);

...
using System;
namespace Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit
{
    /// <summary>
    /// Builds and executes requests for operations under \document\government-ids\{document-id}\submit
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SubmitRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubmitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/document/government-ids/{document%2Did}/submit{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubmitRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/document/government-ids/{document%2Did}/submit{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitPostResponse"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitRequestBuilder.SubmitRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitRequestBuilder.SubmitRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Persona.OpenApiClient.Document.GovernmentIds.Item.Submit.SubmitRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Submits a government ID document for processing. Can only submit `initiated` documents with photos of the ID attached.
        /// </summary>

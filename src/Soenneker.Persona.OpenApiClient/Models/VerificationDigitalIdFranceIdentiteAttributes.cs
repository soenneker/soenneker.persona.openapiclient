...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class VerificationDigitalIdFranceIdentiteAttributes : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes_checks>? Checks { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes_checks> Checks { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes"/> and sets the default values.
        /// </summary>
        public VerificationDigitalIdFranceIdentiteAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "checks", n => { Checks = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes_checks>(global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes_checks.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdFranceIdentiteAttributes_checks>("checks", Checks);

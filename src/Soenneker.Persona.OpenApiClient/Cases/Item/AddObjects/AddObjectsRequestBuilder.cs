...
{
    /// <summary>
    /// Builds and executes requests for operations under \cases\{caseId}\add-objects
    /// </summary>
    ...
    public partial class AddObjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        public AddObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cases/{caseId}/add-objects{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Cases.Item.AddObjects.AddObjectsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cases/{caseId}/add-objects{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjects200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjects200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjectsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.AddObjects.AddObjectsRequestBuilder.AddObjectsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjects200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjectsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.AddObjects.AddObjectsRequestBuilder.AddObjectsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjects200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjects200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Adds Persona objects (such as inquiries, accounts, or reports) to a Case
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjectsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.AddObjects.AddObjectsRequestBuilder.AddObjectsRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.AddPersonaObjectsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.AddObjects.AddObjectsRequestBuilder.AddObjectsRequestBuilderPostQueryParameters>> requestConfiguration = default)

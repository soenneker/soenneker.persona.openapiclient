...
{
    /// <summary>
    /// PII-filtered snapshot of a Database verification. The `peekable-attributes` bag carrieswhichever PII-filtered scalar attributes the source organization&apos;s configuration allows —see `Verification::Database` in the share-token PII filter for the current allowlist.Verification subtypes do not expose a nested `fields` sub-bucket.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SourceDataVerificationDatabase : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationDatabase"/> and sets the default values.
        /// </summary>
        public SourceDataVerificationDatabase()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationDatabase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationDatabase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.SourceDataVerificationDatabase();
        }
        /// <summary>

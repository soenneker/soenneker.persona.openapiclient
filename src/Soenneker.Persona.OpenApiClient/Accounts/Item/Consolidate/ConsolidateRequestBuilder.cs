...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounts\{accountId}\consolidate
    /// </summary>
    ...
    public partial class ConsolidateRequestBuilder : BaseRequestBuilder
    {
        ...
        public ConsolidateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{accountId}/consolidate{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Accounts.Item.Consolidate.ConsolidateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ConsolidateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{accountId}/consolidate{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccount202Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccount202Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccountRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Accounts.Item.Consolidate.ConsolidateRequestBuilder.ConsolidateRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccount202Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccountRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Accounts.Item.Consolidate.ConsolidateRequestBuilder.ConsolidateRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccount202Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccount202Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &quot;Consolidates several source Accounts&apos; information into one target Account. Any Persona resource associated with the source Account will be transferred over to the destination Account. However, the Account&apos;s attributes will **not** be transferred. After consolidation, you can update the destination Account&apos;s attributes using the [Account update endpoint](https://docs.withpersona.com/api-reference/accounts/update-an-account).This endpoint can be used to clean up duplicate Accounts.Note: A source account can only be consolidated once. Afterwards, the source account will be archived and unable to be used moving forward - any attempts to create an inquiry attached to the source account will fail.&quot;
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccountRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Accounts.Item.Consolidate.ConsolidateRequestBuilder.ConsolidateRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.ConsolidateIntoAnAccountRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Accounts.Item.Consolidate.ConsolidateRequestBuilder.ConsolidateRequestBuilderPostQueryParameters>> requestConfiguration = default)

...
{
    /// <summary>
    /// Builds and executes requests for operations under \webhooks\{webhookId}\archive
    /// </summary>
    ...
    public partial class ArchiveRequestBuilder : BaseRequestBuilder
    {
        ...
        public ArchiveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/webhooks/{webhookId}/archive{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Webhooks.Item.Archive.ArchiveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ArchiveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/webhooks/{webhookId}/archive{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        /// Archives a webhook.
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ArchiveAWebhook200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ArchiveAWebhook200Response?> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Webhooks.Item.Archive.ArchiveRequestBuilder.ArchiveRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ArchiveAWebhook200Response> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Webhooks.Item.Archive.ArchiveRequestBuilder.ArchiveRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.ArchiveAWebhook200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.ArchiveAWebhook200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Archives a webhook.
        /// </summary>

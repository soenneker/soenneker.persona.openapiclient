...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class FieldSchemaHashConfig : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>The ignoreUnknownKeys property</summary>
        public bool? IgnoreUnknownKeys { get; set; }
        /// <summary>The itemSchemas property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.FieldSchema>? ItemSchemas { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.FieldSchema> ItemSchemas { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.FieldSchemaHashConfig"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.FieldSchemaHashConfig"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.FieldSchemaHashConfig CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.FieldSchemaHashConfig();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "ignore-unknown-keys", n => { IgnoreUnknownKeys = n.GetBoolValue(); } },
                { "item-schemas", n => { ItemSchemas = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.FieldSchema>(global::Soenneker.Persona.OpenApiClient.Models.FieldSchema.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteBoolValue("ignore-unknown-keys", IgnoreUnknownKeys);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.FieldSchema>("item-schemas", ItemSchemas);

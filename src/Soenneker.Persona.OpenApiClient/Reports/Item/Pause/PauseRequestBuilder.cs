...
{
    /// <summary>
    /// Builds and executes requests for operations under \reports\{reportId}\pause
    /// </summary>
    ...
    public partial class PauseRequestBuilder : BaseRequestBuilder
    {
        ...
        public PauseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/pause{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Reports.Item.Pause.PauseRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PauseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/pause{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ReportActionPauseContinuousMonitoring200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ReportActionPauseContinuousMonitoring200Response?> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.Pause.PauseRequestBuilder.PauseRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ReportActionPauseContinuousMonitoring200Response> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.Pause.PauseRequestBuilder.PauseRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.ReportActionPauseContinuousMonitoring200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.ReportActionPauseContinuousMonitoring200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Pauses continuous monitoring on a report. Requires additional permissions.
        /// </summary>

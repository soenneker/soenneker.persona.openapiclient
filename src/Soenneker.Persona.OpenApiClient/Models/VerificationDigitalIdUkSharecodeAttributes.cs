...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class VerificationDigitalIdUkSharecodeAttributes : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes_checks>? Checks { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes_checks> Checks { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>The immigrationStatus property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> Tags { get; set; }
#endif
        /// <summary>Date from which the immigration status is valid.</summary>
        public Date? ValidFromDate { get; set; }
        /// <summary>Date until which the immigration status is valid.</summary>
        public Date? ValidUntilDate { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes"/> and sets the default values.
        /// </summary>
        public VerificationDigitalIdUkSharecodeAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "checks", n => { Checks = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes_checks>(global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes_checks.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "immigration-status", n => { ImmigrationStatus = n.GetStringValue(); } },
                ...
                { "valid-from-date", n => { ValidFromDate = n.GetDateValue(); } },
                { "valid-until-date", n => { ValidUntilDate = n.GetDateValue(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdUkSharecodeAttributes_checks>("checks", Checks);
            ...
            writer.WriteStringValue("immigration-status", ImmigrationStatus);
            ...
            writer.WriteDateValue("valid-from-date", ValidFromDate);
            writer.WriteDateValue("valid-until-date", ValidUntilDate);

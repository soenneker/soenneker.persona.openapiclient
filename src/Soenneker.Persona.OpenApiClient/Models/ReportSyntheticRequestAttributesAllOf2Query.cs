...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class ReportSyntheticRequestAttributesAllOf2Query : IParsable
...
#nullable restore
        ...
        public string AddressStreet2 { get; set; }
#endif
        /// <summary>Subnational division of a country, such as a state or province. Unabbreviated.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string EmailAddress { get; set; }
#endif
        /// <summary>Any identification number that is not a social security number. One of `identification-number` or `social-security-number` is required.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string PhoneNumber { get; set; }
#endif
        /// <summary>Social security number. One of `identification-number` or `social-security-number` is required.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ReportSyntheticRequestAttributesAllOf2Query"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.ReportSyntheticRequestAttributesAllOf2Query CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.ReportSyntheticRequestAttributesAllOf2Query();
        }
        /// <summary>

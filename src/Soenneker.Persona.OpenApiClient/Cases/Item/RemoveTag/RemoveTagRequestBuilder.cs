...
{
    /// <summary>
    /// Builds and executes requests for operations under \cases\{caseId}\remove-tag
    /// </summary>
    ...
    public partial class RemoveTagRequestBuilder : BaseRequestBuilder
    {
        ...
        public RemoveTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cases/{caseId}/remove-tag{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Cases.Item.RemoveTag.RemoveTagRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveTagRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cases/{caseId}/remove-tag{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.RemoveTag200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.RemoveTag200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.RemoveTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.RemoveTag200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.RemoveTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.RemoveTag200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.RemoveTag200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Removes an existing tag from a Case
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.RemoveTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.RemoveTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>> requestConfiguration = default)

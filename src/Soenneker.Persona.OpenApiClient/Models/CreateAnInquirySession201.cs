...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class CreateAnInquirySession201 : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included>? Included { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included> Included { get; set; }
#endif
        ...
        public static global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "included", n => { Included = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included>(global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included>("included", Included);
        }
        /// <summary>
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class CreateAnInquirySession201_included : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.Persona.OpenApiClient.Models.CreateAnInquirySession201.CreateAnInquirySession201_included();

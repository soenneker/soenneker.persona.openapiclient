...
{
    /// <summary>
    /// Builds and executes requests for operations under \reports\{reportId}\print
    /// </summary>
    ...
    public partial class PrintRequestBuilder : BaseRequestBuilder
    {
        ...
        public PrintRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/print", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Reports.Item.Print.PrintRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PrintRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/print", rawUrl)
        {
        }
        /// <summary>

...
{
    /// <summary>
    /// Builds and executes requests for operations under \connect\connections\{connectionId}\deactivate
    /// </summary>
    ...
    public partial class DeactivateRequestBuilder : BaseRequestBuilder
    {
        ...
        public DeactivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connect/connections/{connectionId}/deactivate", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Connect.Connections.Item.Deactivate.DeactivateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeactivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connect/connections/{connectionId}/deactivate", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.DeactivateAConnectConnection200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.DeactivateAConnectConnection200Response?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.DeactivateAConnectConnection200Response> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.DeactivateAConnectConnection200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.DeactivateAConnectConnection200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Deactivates a Connection. Either the source or destination organization may deactivate a connection that is currently `pending` or `active`. Deactivation prevents further access through the connection but maintains the connection record. Connections that are already `inactive` cannot be deactivated again.
        /// </summary>

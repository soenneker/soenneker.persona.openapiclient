...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class ReportBusinessAssociatedPersonsAttributesAllOf2OwnershipInformationOwnersItemRolesItem : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ReportBusinessAssociatedPersonsAttributesAllOf2OwnershipInformationOwnersItemRolesItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.ReportBusinessAssociatedPersonsAttributesAllOf2OwnershipInformationOwnersItemRolesItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.ReportBusinessAssociatedPersonsAttributesAllOf2OwnershipInformationOwnersItemRolesItem();
        }
        /// <summary>

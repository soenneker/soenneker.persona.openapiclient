...
{
    /// <summary>
    /// Builds and executes requests for operations under \inquiries\{inquiryId}\remove-tag
    /// </summary>
    ...
    public partial class RemoveTagRequestBuilder : BaseRequestBuilder
    {
        ...
        public RemoveTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/remove-tag{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Inquiries.Item.RemoveTag.RemoveTagRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveTagRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/remove-tag{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.InquiriesRemoveTag200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.InquiriesRemoveTag200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.InquiriesTagRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.InquiriesRemoveTag200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.InquiriesTagRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.InquiriesRemoveTag200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.InquiriesRemoveTag200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Removes an existing tag from an Inquiry.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.InquiriesTagRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.InquiriesTagRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.RemoveTag.RemoveTagRequestBuilder.RemoveTagRequestBuilderPostQueryParameters>> requestConfiguration = default)

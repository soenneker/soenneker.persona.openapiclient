...
{
    /// <summary>
    /// Builds and executes requests for operations under \reports\{reportId}\dismiss
    /// </summary>
    ...
    public partial class DismissRequestBuilder : BaseRequestBuilder
    {
        ...
        public DismissRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/dismiss{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Reports.Item.Dismiss.DismissRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DismissRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/dismiss{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.DismissMatches200Response"/></returns>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.DismissMatches200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.DismissMatchesRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.Dismiss.DismissRequestBuilder.DismissRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.DismissMatches200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.DismissMatches200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Dismisses active matches for supported report types
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.DismissMatchesRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.Dismiss.DismissRequestBuilder.DismissRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.DismissMatchesRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.Dismiss.DismissRequestBuilder.DismissRequestBuilderPostQueryParameters>> requestConfiguration = default)

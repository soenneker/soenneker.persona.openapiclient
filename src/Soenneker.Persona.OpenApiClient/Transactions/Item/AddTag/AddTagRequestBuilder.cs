...
{
    /// <summary>
    /// Builds and executes requests for operations under \transactions\{transaction-id}\add-tag
    /// </summary>
    ...
    public partial class AddTagRequestBuilder : BaseRequestBuilder
    {
        ...
        public AddTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/transactions/{transaction%2Did}/add-tag{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddTagRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/transactions/{transaction%2Did}/add-tag{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagPostResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagPostResponse?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.TransactionsAddTag body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagPostResponse> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.TransactionsAddTag body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.TransactionsAddTag body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.TransactionsAddTag body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Transactions.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>> requestConfiguration = default)

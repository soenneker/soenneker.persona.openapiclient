...
{
    /// <summary>
    /// Builds and executes requests for operations under \api-keys\{apiKeyId}\clone
    /// </summary>
    ...
    public partial class CloneRequestBuilder : BaseRequestBuilder
    {
        ...
        public CloneRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api-keys/{apiKeyId}/clone{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Clone.CloneRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CloneRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api-keys/{apiKeyId}/clone{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        /// Creates a copy of an existing API key. All attributes except the value are copied over to the new API key.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.CloneApiKey200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.CloneApiKey200Response?> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Clone.CloneRequestBuilder.CloneRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.CloneApiKey200Response> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Clone.CloneRequestBuilder.CloneRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.CloneApiKey200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.CloneApiKey200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a copy of an existing API key. All attributes except the value are copied over to the new API key.
        /// </summary>

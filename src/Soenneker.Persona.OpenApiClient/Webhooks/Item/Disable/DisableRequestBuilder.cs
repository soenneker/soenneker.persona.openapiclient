...
{
    /// <summary>
    /// Builds and executes requests for operations under \webhooks\{webhookId}\disable
    /// </summary>
    ...
    public partial class DisableRequestBuilder : BaseRequestBuilder
    {
        ...
        public DisableRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/webhooks/{webhookId}/disable{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Webhooks.Item.Disable.DisableRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DisableRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/webhooks/{webhookId}/disable{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        /// Disables a webhook.
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.DisableAWebhook200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.DisableAWebhook200Response?> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Webhooks.Item.Disable.DisableRequestBuilder.DisableRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.DisableAWebhook200Response> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Webhooks.Item.Disable.DisableRequestBuilder.DisableRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.DisableAWebhook200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.DisableAWebhook200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Disables a webhook.
        /// </summary>

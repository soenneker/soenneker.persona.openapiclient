...
{
    /// <summary>
    /// Builds and executes requests for operations under \inquiries\{inquiryId}\decline
    /// </summary>
    ...
    public partial class DeclineRequestBuilder : BaseRequestBuilder
    {
        ...
        public DeclineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/decline{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Decline.DeclineRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeclineRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/decline{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.DeclineAnInquiry200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.DeclineAnInquiry200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Decline.DeclineRequestBuilder.DeclineRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.DeclineAnInquiry200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Decline.DeclineRequestBuilder.DeclineRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.DeclineAnInquiry200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.DeclineAnInquiry200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Declines an Inquiry.Note that this action will trigger any associated workflows and webhooks.Declining an inquiry will prevent further progress on the inquiry.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Decline.DeclineRequestBuilder.DeclineRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Decline.DeclineRequestBuilder.DeclineRequestBuilderPostQueryParameters>> requestConfiguration = default)

...
{
    /// <summary>
    /// Builds and executes requests for operations under \inquiries\{inquiryId}\approve
    /// </summary>
    ...
    public partial class ApproveRequestBuilder : BaseRequestBuilder
    {
        ...
        public ApproveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/approve{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Approve.ApproveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApproveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/approve{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ApproveAnInquiry200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ApproveAnInquiry200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Approve.ApproveRequestBuilder.ApproveRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ApproveAnInquiry200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Approve.ApproveRequestBuilder.ApproveRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.ApproveAnInquiry200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.ApproveAnInquiry200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Approves an Inquiry.Note that this action will trigger any associated workflows and webhooks.Approving an inquiry will prevent further progress on the inquiry.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Approve.ApproveRequestBuilder.ApproveRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.InquiriesReviewRequestRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Approve.ApproveRequestBuilder.ApproveRequestBuilderPostQueryParameters>> requestConfiguration = default)

...
{
    /// <summary>
    /// Builds and executes requests for operations under \reports\{reportId}\add-tag
    /// </summary>
    ...
    public partial class AddTagRequestBuilder : BaseRequestBuilder
    {
        ...
        public AddTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/add-tag{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Reports.Item.AddTag.AddTagRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddTagRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/{reportId}/add-tag{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTag200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTag200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTag200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTag200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTag200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Adds a new tag to the Report
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.ReportsAddTagRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Reports.Item.AddTag.AddTagRequestBuilder.AddTagRequestBuilderPostQueryParameters>> requestConfiguration = default)

...
using System;
namespace Soenneker.Persona.OpenApiClient.Document.Generics.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \document\generics\{document-id}
    /// </summary>
    ...
    public partial class DocumentItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public DocumentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/document/generics/{document%2Did}{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DocumentItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/document/generics/{document%2Did}{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieves the details of a generic document that has been previously created.
        /// Full documentation for this API on the Persona website. <see href="https://docs.withpersona.com/api-reference/documents/retrieve-a-generic-document" />
        /// </summary>
        ...
        /// <exception cref="global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200400Error">When receiving a 400 status code</exception>
        /// <exception cref="global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200401Error">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200403Error">When receiving a 403 status code</exception>
        /// <exception cref="global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200404Error">When receiving a 404 status code</exception>
        /// <exception cref="global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200429Error">When receiving a 429 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder.DocumentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200> GetAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder.DocumentItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200400Error.CreateFromDiscriminatorValue },
                { "401", global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200401Error.CreateFromDiscriminatorValue },
                { "403", global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200403Error.CreateFromDiscriminatorValue },
                { "404", global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200404Error.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.Persona.OpenApiClient.Models.Retrieve_a_generic_document_200429Error.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder.DocumentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder.DocumentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves the details of a generic document that has been previously created.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class DocumentItemRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder.DocumentItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Updates an existing generic document. Can only update `initiated` documents.
...
#nullable restore
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class DocumentItemRequestBuilderPatchRequestConfiguration : RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Document.Generics.Item.DocumentItemRequestBuilder.DocumentItemRequestBuilderPatchQueryParameters>
        {
        }
    }
}

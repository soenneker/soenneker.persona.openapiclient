...
{
    /// <summary>
    /// Builds and executes requests for operations under \importer\accounts
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class AccountsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/importer/accounts{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/importer/accounts{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsPostResponse?> PostAsAccountsPostResponseAsync(global::Soenneker.Persona.OpenApiClient.Models.Import_an_accountmultipart_form_data body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder.AccountsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsPostResponse> PostAsAccountsPostResponseAsync(global::Soenneker.Persona.OpenApiClient.Models.Import_an_accountmultipart_form_data body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder.AccountsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsResponse?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.Import_an_accountmultipart_form_data body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder.AccountsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsResponse> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.Import_an_accountmultipart_form_data body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder.AccountsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsResponse>(requestInfo, global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Bulk import accounts by uploading a CSV file.Each row should be the details for a new account. The columns we allow are:  - reference_id  - name_first  - name_middle  - name_last  - birthdate  - social_security_number  - tags
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Bulk import accounts by uploading a CSV file.Each row should be the details for a new account. The columns we allow are:  - reference_id  - name_first  - name_middle  - name_last  - birthdate  - social_security_number  - tags
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AccountsRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Importer.Accounts.AccountsRequestBuilder.AccountsRequestBuilderPostQueryParameters>
        {
        }
    }
}

...
{
    /// <summary>
    /// Builds and executes requests for operations under \user-audit-logs\{userAuditLogId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithUserAuditLogItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.UserAuditLogs.Item.WithUserAuditLogItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserAuditLogItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user-audit-logs/{userAuditLogId}{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.UserAuditLogs.Item.WithUserAuditLogItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserAuditLogItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user-audit-logs/{userAuditLogId}{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.RetrieveAUserAuditLog200Response?> GetAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.UserAuditLogs.Item.WithUserAuditLogItemRequestBuilder.WithUserAuditLogItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.RetrieveAUserAuditLog200Response> GetAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.UserAuditLogs.Item.WithUserAuditLogItemRequestBuilder.WithUserAuditLogItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.UserAuditLogs.Item.WithUserAuditLogItemRequestBuilder.WithUserAuditLogItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.UserAuditLogs.Item.WithUserAuditLogItemRequestBuilder.WithUserAuditLogItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Persona.OpenApiClient.UserAuditLogs.Item.WithUserAuditLogItemRequestBuilder WithUrl(string rawUrl)
        {

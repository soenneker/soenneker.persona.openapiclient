...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class VerificationDigitalIdGenericAttributes : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes_checks>? Checks { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes_checks> Checks { get; set; }
#endif
...
#nullable restore
        ...
        public string ResponseStatus { get; set; }
#endif
        /// <summary>The country selected by the end user for verification.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string SelectedCountryCode { get; set; }
#endif
        /// <summary>The digital ID type selected by the end user.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? SelectedDigitalIdType { get; set; }
#nullable restore
#else
        public string SelectedDigitalIdType { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes"/> and sets the default values.
        /// </summary>
        public VerificationDigitalIdGenericAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "checks", n => { Checks = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes_checks>(global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes_checks.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "selected-digital-id-type", n => { SelectedDigitalIdType = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationDigitalIdGenericAttributes_checks>("checks", Checks);
            ...
            writer.WriteStringValue("selected-digital-id-type", SelectedDigitalIdType);

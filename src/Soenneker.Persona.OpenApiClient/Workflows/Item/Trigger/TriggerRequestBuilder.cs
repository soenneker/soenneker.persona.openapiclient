...
{
    /// <summary>
    /// Builds and executes requests for operations under \workflows\{workflowId}\trigger
    /// </summary>
    ...
    public partial class TriggerRequestBuilder : BaseRequestBuilder
    {
        ...
        public TriggerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/workflows/{workflowId}/trigger{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Workflows.Item.Trigger.TriggerRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TriggerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/workflows/{workflowId}/trigger{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.CreateAWorkflowRun200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.CreateAWorkflowRunRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Workflows.Item.Trigger.TriggerRequestBuilder.TriggerRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.CreateAWorkflowRun200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.CreateAWorkflowRunRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Workflows.Item.Trigger.TriggerRequestBuilder.TriggerRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.CreateAWorkflowRunRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Workflows.Item.Trigger.TriggerRequestBuilder.TriggerRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.CreateAWorkflowRunRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Workflows.Item.Trigger.TriggerRequestBuilder.TriggerRequestBuilderPostQueryParameters>> requestConfiguration = default)

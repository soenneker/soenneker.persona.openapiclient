...
{
    /// <summary>
    /// Builds and executes requests for operations under \inquiries\{inquiryId}\expire
    /// </summary>
    ...
    public partial class ExpireRequestBuilder : BaseRequestBuilder
    {
        ...
        public ExpireRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/expire{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Expire.ExpireRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExpireRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/inquiries/{inquiryId}/expire{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ExpireAnInquiry200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ExpireAnInquiry200Response?> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Expire.ExpireRequestBuilder.ExpireRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ExpireAnInquiry200Response> PostAsync(Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Inquiries.Item.Expire.ExpireRequestBuilder.ExpireRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.ExpireAnInquiry200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.ExpireAnInquiry200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Expires an Inquiry and all sessions on the Inquiry. Cancels any pending Verifications on the inquiry.The Inquiry can still be resumed after expiry.
        /// </summary>

...
{
    /// <summary>
    /// Builds and executes requests for operations under \api-keys\{apiKeyId}\expire
    /// </summary>
    ...
    public partial class ExpireRequestBuilder : BaseRequestBuilder
    {
        ...
        public ExpireRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api-keys/{apiKeyId}/expire{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Expire.ExpireRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExpireRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api-keys/{apiKeyId}/expire{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKey200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKey200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKeyRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Expire.ExpireRequestBuilder.ExpireRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKey200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKeyRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Expire.ExpireRequestBuilder.ExpireRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKey200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKey200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Deactivates an API key within some time period
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKeyRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Expire.ExpireRequestBuilder.ExpireRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.ExpireAnApiKeyRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.ApiKeys.Item.Expire.ExpireRequestBuilder.ExpireRequestBuilderPostQueryParameters>> requestConfiguration = default)

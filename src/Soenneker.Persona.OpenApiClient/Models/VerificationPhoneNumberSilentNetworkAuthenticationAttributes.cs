...
namespace Soenneker.Persona.OpenApiClient.Models
{
    ...
    public partial class VerificationPhoneNumberSilentNetworkAuthenticationAttributes : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes_checks>? Checks { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes_checks> Checks { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes"/> and sets the default values.
        /// </summary>
        public VerificationPhoneNumberSilentNetworkAuthenticationAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "checks", n => { Checks = n.GetCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes_checks>(global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes_checks.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Persona.OpenApiClient.Models.VerificationPhoneNumberSilentNetworkAuthenticationAttributes_checks>("checks", Checks);

...
{
    /// <summary>
    /// Builds and executes requests for operations under \cases\{caseId}\set-tags
    /// </summary>
    ...
    public partial class SetTagsRequestBuilder : BaseRequestBuilder
    {
        ...
        public SetTagsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cases/{caseId}/set-tags{?fields*,include*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Persona.OpenApiClient.Cases.Item.SetTags.SetTagsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetTagsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cases/{caseId}/set-tags{?fields*,include*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Persona.OpenApiClient.Models.SetTags200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.SetTags200Response?> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.SetTagsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.SetTags.SetTagsRequestBuilder.SetTagsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Persona.OpenApiClient.Models.SetTags200Response> PostAsync(global::Soenneker.Persona.OpenApiClient.Models.SetTagsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.SetTags.SetTagsRequestBuilder.SetTagsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Persona.OpenApiClient.Models.SetTags200Response>(requestInfo, global::Soenneker.Persona.OpenApiClient.Models.SetTags200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Sets all tags on a Case. Any tags that are not provided in the request will be removed.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.SetTagsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.SetTags.SetTagsRequestBuilder.SetTagsRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Persona.OpenApiClient.Models.SetTagsRequest body, Action<RequestConfiguration<global::Soenneker.Persona.OpenApiClient.Cases.Item.SetTags.SetTagsRequestBuilder.SetTagsRequestBuilderPostQueryParameters>> requestConfiguration = default)
